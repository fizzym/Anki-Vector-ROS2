...
#ifndef VECTOR__SRV__DETAIL__VECTOR_SPEAK__FUNCTIONS_H_
#define VECTOR__SRV__DETAIL__VECTOR_SPEAK__FUNCTIONS_H_
...
/// Initialize srv/VectorSpeak message.
/**
...
/// Finalize srv/VectorSpeak message.
/**
...
/// Create srv/VectorSpeak message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vector__srv__VectorSpeak_Request__init().
...
/// Destroy srv/VectorSpeak message.
/**
 * It calls
 * vector__srv__VectorSpeak_Request__fini()
...
/// Initialize array of srv/VectorSpeak messages.
/**
...
/// Finalize array of srv/VectorSpeak messages.
/**
 * It calls
 * vector__srv__VectorSpeak_Request__fini()
...
/// Create array of srv/VectorSpeak messages.
/**
 * It allocates the memory for the array and calls
 * vector__srv__VectorSpeak_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VectorSpeak messages.
/**
 * It calls
 * vector__srv__VectorSpeak_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vector__srv__VectorSpeak_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vector
...
/**
 * It calls
 * vector__srv__VectorSpeak_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vector
...
/**
 * It allocates the memory for the array and calls
 * vector__srv__VectorSpeak_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vector
...
/**
 * It calls
 * vector__srv__VectorSpeak_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VECTOR__SRV__DETAIL__VECTOR_SPEAK__FUNCTIONS_H_
